...
export default function Footer (props) {
  ...
  return <footer className="relative w-full bg-black px-6 border-t">
        ...
        <div className="text-yellow-300 container mx-auto max-w-4xl py-4 md:flex flex-wrap md:flex-no-wrap md:justify-between items-center text-sm">
            ...
            <div className="md:p-0 text-center md:text-right text-xs">
                ...
                <span className='no-underline ml-4'>
                    Powered by
                    <a href="https://github.com/CarlQvQ/NotionNext" className=' hover:underline'> NotionNext {siteConfig('VERSION')}  </a>
                </span>
            </div>
        </div>
    </footer>
